...
def recherche_pokemons():
    ...
    # On applique la méthode fetchall()
...
def recherche_attributs_pokemon(nom_pokemon):
    """
    crée une classe de type Pokemon et
    renvoie un objet de type Pokemon avec les atributs
            self.id:int
            self.name:str
            self.nom:str
            self.pv : int
    ...
    class Pokemon :
        def __init__(self):
            ...
            self.defense_speciale :int
            self.vitesse:int
            self.evolution_de:str
            self.evolutions:list
            self.description:str
    # Création instance de la classe Pokemon
    pokemon=Pokemon()
    # Création de la connexion
    bdd = creer_connection("pokemon.db")
    # creation du curseur de la connexion
    ...
    pokemon.id=reponse[0]
    pokemon.name=reponse[1]
    pokemon.nom=reponse[2]
    pokemon.pv=reponse[3]
    pokemon.attaque=reponse[4]
    pokemon.defense=reponse[5]
    pokemon.attaque_speciale=reponse[6]
    pokemon.defense_speciale=reponse[7]
    pokemon.vitesse=reponse[8]
    pokemon.description=reponse[10]
    numero_pokemon_evolution_de=reponse[9]
    # Si le pokemon est évolution d'un autre pokemon
    if numero_pokemon_evolution_de!=None:
        ...
        pokemon.evolution_de=reponse2[0]
    else:
        pokemon.evolution_de="---"
    return pokemon
...
def recherche_evolutions(nom_pokemon):
    ...
    # creation du curseur de la connexion
    curseur = bdd.cursor()
    # 1 recherche de l'id du pokemon
    # Ecriture de la requête
